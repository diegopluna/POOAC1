...
import br.gov.cesarschool.poo.bonusvendas.entidade.LancamentoBonusResgate;
...
public class TesteAcumuloResgateMediator extends TesteGeral {
	...
	public void testResgateValorNumeroOk() {
		...
		Serializable[] lancamentos = cadastroLanc.buscarTodos();
		Assertions.assertTrue(lancamentos[0] instanceof LancamentoBonusResgate);
		LancamentoBonusResgate lbd = (LancamentoBonusResgate)lancamentos[0];
